...
public class BusinessOffersListDTO {
    ...
    private String isActiveStatusFlag;
	...
	public String getIsActiveStatusFlag() {
		return isActiveStatusFlag;
	}

	public void setIsActiveStatusFlag(String isActiveStatusFlag) {
		this.isActiveStatusFlag = isActiveStatusFlag;
	}
